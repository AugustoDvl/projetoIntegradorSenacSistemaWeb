...
<div id="principal">
    ...
    <img src="imgs/LOGO 2.png" alt="logo fit life">

<h1 id="op1">Iniciar novo projeto</h1>
...
<form method="get" action="projeto.php">
    ...
    <h1>Sexo</h1>
    <input class="seletor" type= "radio" name="genero" value="1"><p class="texto">Masculino</p>
    <input class="seletor" type= "radio" name="genero" value="2"><p class="texto">Feminino</p>
    <h1>Peso</h1>
    <input id="op1" type = "number" name = "peso" placeholder = "Digite seu Peso">
    <h1>Altura</h1>
    <input type= "number" name = "altura" placeholder = "Digite sua Altura em Centimetros">
    <h1>Idade</h1>
